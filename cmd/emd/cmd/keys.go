...
// Forked in order to override the --keyring-backend flag.
// TODO Find a way to merely modify the flag, and not have to fork the whole file
func KeysCommands(defaultNodeHome string) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "keys",
