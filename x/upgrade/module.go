...
func (AppModuleBasic) GetTxCmd() (_ *cobra.Command) {
	return
}
...
func (am AppModule) InitGenesis(_ sdk.Context, _ codec.JSONMarshaler, _ json.RawMessage) (_ []abci.ValidatorUpdate) {
	return
}
...
func (am AppModule) BeginBlock(ctx sdk.Context, req abci.RequestBeginBlock) {
	upgrade.BeginBlocker(am.keeper, ctx, req)
}

// EndBlock does nothing
func (am AppModule) EndBlock(_ sdk.Context, _ abci.RequestEndBlock) (_ []abci.ValidatorUpdate) {
	return
}
