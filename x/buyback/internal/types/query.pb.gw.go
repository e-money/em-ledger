...
var (
	pattern_Query_Balance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"e-money", "buyback", "v1beta1", "balance"}, "", runtime.AssumeColonVerbOpt(true)))
)
