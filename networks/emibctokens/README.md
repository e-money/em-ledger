...
```
curl https://get.starport.network/e-money/stargate@latest! | sudo bash
```
`e-money/stargate` should match the `username` and `repo_name` of the Github repository to which the source code was pushed. Learn more about [the install process](https://github.com/allinbits/starport-installer).
