...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.SwapPacketData
	...
	case *types.SwapPacketData_SendPacket:
		packetAck, err := am.keeper.OnRecvSendPacket(ctx, modulePacket, *packet.SendPacket)
		if err != nil {
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *types.SwapPacketData_SendPacket:
		err := am.keeper.OnAcknowledgementSendPacket(ctx, modulePacket, *packet.SendPacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = types.EventTypeSendPacket
	default:
		errMsg := fmt.Sprintf("unrecognized %s packet type: %T", types.ModuleName, packet)
...
func (am AppModule) OnTimeoutPacket(
	...
	case *types.SwapPacketData_SendPacket:
		err := am.keeper.OnTimeoutSendPacket(ctx, modulePacket, *packet.SendPacket)
		if err != nil {
			return nil, err
		}
	default:
